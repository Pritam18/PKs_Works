...
namespace ENTITY
{
    public class Car_Info
    {
        ...
        Pen bluepen = new Pen(Color.Gold, 3);
        Pen ypen = new Pen(Color.AntiqueWhite, 27);
        Pen ypen2 = new Pen(Color.Gold, 7);
        Pen bpen = new Pen(Color.AntiqueWhite, 17);
        ...
        public void drawCar(Graphics g)
        {
            ...
            //left side........
            g.DrawLine(new Pen(Color.Gold, 4), 45, 45, 95, 45);
            g.DrawLine(new Pen(Color.Gold, 4), 10, 48, 47, 45);
            g.DrawLine(new Pen(Color.Gold, 4), 93, 45, 135, 48);

            //right side........
            g.DrawLine(new Pen(Color.Gold, 4), 45, 95, 95, 95);
            g.DrawLine(new Pen(Color.Gold, 4), 10, 92, 47, 95);
            g.DrawLine(new Pen(Color.Gold, 4), 93, 95, 135, 92);
            ...
            g.DrawLine(new Pen(Color.Red, 7), 130, 50, 144, 55);
            g.DrawLine(new Pen(Color.Red, 7), 130, 90, 144, 85);
            //back................
